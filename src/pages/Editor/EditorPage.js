...
function EditorPage() {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "editor-page", children: [(0, jsx_runtime_1.jsx)(Title_1.default, { title: "Editor" }), (0, jsx_runtime_1.jsx)(EditorToolbar_1.default, { title: reportTitle, onTitleChange: (e) => setReportTitle(e.target.value), onBold: () => { }, onItalic: () => { }, onUnderline: () => { }, onSave: () => { }, onExport: () => { } }), (0, jsx_runtime_1.jsxs)("div", { className: "editor-field-container", children: [(0, jsx_runtime_1.jsx)("label", { htmlFor: "editorField", children: "Report text:" }), (0, jsx_runtime_1.jsx)("br", {}), (0, jsx_runtime_1.jsx)("textarea", { id: "editorField", className: "editor-field", placeholder: "Write your report here...", value: reportText, onChange: (e) => setReportText(e.target.value) })] })] }), (0, jsx_runtime_1.jsx)("div", { className: "some-footer" })] }));
}
